      ...
      data: {
        ...
        flightDetails: {
          create: data.flightDetails.map((flight) => ({
            ...
            cabinBaggageKg: (flight as any).cabinBaggageKg ?? (flight as any).carryOnBaggageKg ?? 7,
            ...
            transportCategory: flight.transportCategory || "Inter-City Transfer",
            fromCity: flight.fromCity || null,
            toCity: flight.toCity || null,
            isAutoSuggested: Boolean(flight.isAutoSuggested),
